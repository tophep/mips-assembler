...
#
#  Invoke as:  ./prepM1.sh <name of tar file>
#
...
#     - Execute the command "./prepM1 <student's PID>" and check for errors;
...
# Initiate log file
   echo "Executing prepM1.sh on $tarFile" > $Log
   echo >> $Log
