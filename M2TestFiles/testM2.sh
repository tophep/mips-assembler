...
# prep results files
   echo "Detailed results from executing testM2" > $resultsLog
...
# complete summary file
   echo "Summary results from executing testM2" > $summaryLog
